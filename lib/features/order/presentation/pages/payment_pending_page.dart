...
class _PaymentPendingPageState extends State<PaymentPendingPage>
  ...
  // Menandakan apakah OTP (2FA) sudah pernah diverifikasi di sesi ini.
  // Kalau sudah true, tombol "Buka Dompet Kampus Global" tidak akan
  // mengarahkan user ke SetupOTPPage lagi.
  ...
  // ==============================
  // Buka aplikasi Dompet Kampus Global
  // ==============================
  // Kalau OTP (2FA) belum pernah diverifikasi di sesi ini, user diarahkan
  // dulu ke SetupOTPPage. Halaman itu akan pop(true) kalau setup selesai
  // (baik ditekan manual maupun otomatis lewat timer 60 detik).
  // Setelah itu baru _launchGlobalInstitutePay() dipanggil — HANYA SEKALI.
